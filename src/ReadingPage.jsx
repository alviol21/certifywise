        ...
        <div className="skillsWrap">
          <div className="skillsNav">
            {READING_SKILLS.map(sk => (
              <button key={sk.id} className={`skillsNavBtn${sk.id === activeSkillId ? " on" : ""}`} onClick={() => { setActiveSkillId(sk.id); setActivePassageIdx(0); setDemoRevealed(false); setExampleRevealed(false); }}>
                {sk.title}
              </button>
            ))}
          </div>
